...
Esse projeto tem como objetivo traduzir as texturas, interface e os textos de **Ricochet** para outros idiomas que não possuem uma tradução oficial, de maneira comunitária, de fã para fã.
...
<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=750046&height=100&section=footer"/>